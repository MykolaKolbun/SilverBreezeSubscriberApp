...
const uk: Dict = {
  ...
  'auth.phone.title': 'Вхід за номером телефону',
  'auth.phone.subtitle': 'Надішлемо код підтвердження у SMS.',
  'auth.phone.send': 'Отримати код',
  'auth.code.title': 'Введіть код',
  'auth.code.sentTo': 'Код надіслано на {phone}',
  'auth.code.verify': 'Підтвердити',
  'auth.code.changeNumber': 'Змінити номер',
  'auth.code.resend': 'Надіслати ще раз',
  'auth.err.phone': 'Не вдалося надіслати код.',
...
const en: Dict = {
  ...
  'auth.phone.subtitle': 'We will send a verification code by SMS.',
  'auth.phone.send': 'Get code',
  'auth.code.title': 'Enter the code',
  'auth.code.sentTo': 'Code sent to {phone}',
  'auth.code.verify': 'Verify',
  'auth.code.changeNumber': 'Change number',
  'auth.code.resend': 'Resend',
  'auth.err.phone': 'Could not send the code.',
